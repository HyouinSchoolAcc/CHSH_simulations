...
This implementation should provide the correct Spearman's rank correlation coefficient when provided two lists (or numpy arrays) of the same length.
...
Spearman_correlation_transfer_frozen = spearman_rank_correlation(labels_flat,all_predictions_flat)
