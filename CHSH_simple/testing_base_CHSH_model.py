...
if __name__ == '__main__':
    # Load the model
    model_path = r"c:\Users\17536\Desktop\CHSH\saved_models\best_model_trial_1.pth" # Update with your model's path
    n_layers = 3  # Number of hidden layers
    layer_sizes = [17, 89, 49]
    model = load_model(model_path, n_layers, layer_sizes)

    # Load test data
    test_file_path = r"c:\Users\17536\Desktop\CHSH\data\test.txt"  # Update with your test data path
